...
const CLAUSE_KEYWORDS = {
  '4.1':  ['ความเป็นกลาง', 'เปิดเผยกิจกรรม'],
  '4.2':  ['รักษาความลับ', 'ความลับ'],
  '6.2':  ['บุคลากร', 'ฝึกอบรม', 'ความสามารถของเจ้าหน้าที่', 'อบรม', 'JOB DESCRIPTION', 'คำบรรยายลักษณะงาน'],
  '6.3':  ['สภาพแวดล้อม', 'ผังห้องปฏิบัติการ', 'ผังห้อง', 'สภาวะแวดล้อมในห้องปฏิบัติการ', 'เข้า-ออกพื้นที่'],
  '6.4':  ['บำรุงรักษาเครื่องมือ', 'ซ่อมบำรุงเครื่องมือ', 'ทะเบียนเครื่องมือ', 'โพลาริมิเตอร์', 'การใช้เครื่องชั่ง', 'รีแฟคโตมิเตอร์', 'Water Bath', 'การใช้ตู้อบ', 'ตรวจสอบเครื่องชั่งประจำวัน', 'ตรวจสอบเครื่องมือประจำวัน', 'ประวัติเครื่องมือ', 'นำเครื่องมือออกจากห้องปฏิบัติการ', 'ทวนสอบเครื่องมือ'],
  '6.5':  ['สอบเทียบ', 'สอบกลับได้ทางมาตรวิทยา', 'สอบกลับได้', 'มาตรวิทยา', 'CERT.', 'CERT_', 'Reference Material', 'Moisture Reference'],
  '6.6':  ['จัดซื้อ', 'ผู้ขาย', 'ผู้ให้บริการภายนอก', 'ภายนอก'],
  '7.1':  ['ทบทวนคำขอ', 'ข้อเสนอการประมูล', 'ข้อสัญญา', 'ทบทวนสัญญา', 'คำร้องขอรับการบริการทดสอบ', 'คำร้องขอรับบริการทดสอบ'],
  '7.2':  ['ทวนสอบวิธี', 'ตรวจสอบความใช้ได้ของวิธี', 'วิธีทดสอบ', 'วิธีปฏิบัติงาน', 'วิธีวัดค่า', 'การวิเคราะห์ค่า', 'ICUMSA', 'SOP_', 'Laboratory Manual', 'ผลทบทวนความใช้ได้ของวิธีการทดสอบ'],
  '7.3':  ['สุ่มตัวอย่าง', 'เก็บตัวอย่าง'],
  '7.4':  ['จัดการตัวอย่าง', 'รับตัวอย่างเข้าห้องปฏิบัติการ', 'รับตัวอย่าง', 'ทะเบียนบันทึกตัวอย่างทดสอบ', 'ทะเบียนตัวอย่าง'],
  '7.5':  ['บันทึกทางวิชาการ', 'บันทึกผลทดสอบ', 'บันทึกผลการทดสอบ', 'แบบบันทึกการแยกชั้น'],
  '7.6':  ['ความไม่แน่นอนของการวัด', 'ความไม่แน่นอน'],
  '7.7':  ['ทดสอบความชำนาญ', 'เปรียบเทียบผลระหว่างห้องปฏิบัติการ', 'ความใช้ได้ของผล', 'เปรียบเทียบผลทดสอบระหว่างห้องปฏิบัติการ', 'การเตรียมตัวอย่างและการเปรียบเทียบผลทดสอบ'],
  '7.8':  ['รายงานผลการทดสอบ', 'ใบรายงานผล', 'การรายงานผล', 'แบบรายงานผลวิเคราะห์'],
  '7.9':  ['ข้อร้องเรียน', 'ร้องเรียน'],
  '7.10': ['งานที่ไม่เป็นไปตามข้อกำหนด', 'ไม่เป็นไปตามข้อกำหนด', 'ไม่เป็นไปตามที่กำหนด', 'ความไม่สอดคล้อง', 'Non-Conformity', 'Non-Conforming'],
  '7.11': ['การควบคุมข้อมูล', 'ระบบสารสนเทศ'],
  '8.2':  ['คู่มือคุณภาพ', 'แผนบริหารจัดการระบบคุณภาพ'],
  '8.3':  ['การควบคุมเอกสาร', 'ควบคุมเอกสาร', 'ทะเบียนรายชื่อเอกสาร', 'คำร้องขอดำเนินการด้านเอกสารคุณภาพ', 'ทบทวนประสิทธิผลของเอกสาร'],
  '8.4':  ['การควบคุมบันทึก', 'ควบคุมบันทึก'],
  '8.5':  ['ความเสี่ยงและโอกาส', 'บริหารความเสี่ยง', 'ความเสี่ยง'],
  '8.6':  ['การปรับปรุง', 'ความพึงพอใจ'],
  '8.7':  ['การปฏิบัติการแก้ไข', 'ข้อร้องขอให้แก้ไข', 'แก้ไข'],
  '8.8':  ['การตรวจติดตามภายใน', 'ตรวจติดตามภายใน', 'ตรวจติดตามคุณภาพภายใน'],
  '8.9':  ['การทบทวนของฝ่ายบริหาร', 'ทบทวนของฝ่ายบริหาร', 'ทบทวนการบริหาร', 'วัตถุประสงค์คุณภาพ'],
};

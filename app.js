...
// หมายเหตุ: มีให้เฉพาะไฟล์ "ตัวปกติ" (regular) เท่านั้น ยังไม่มีไฟล์ "ตัวหนา"
// (bold) แยกต่างหาก — ตอนนี้ loadThaiFontBold() เลยใช้ไฟล์เดียวกับตัวปกติไปก่อน
// ส่วนความหนาของหัวตาราง (ที่ต้องการให้เป็นตัวหนา) จำลองด้วยการวาดข้อความซ้ำ
// เหลื่อมกันเล็กน้อย (faux bold — ดู DILLENIA_HAS_REAL_BOLD ในฟังก์ชันวาด PDF)
// แทนน้ำหนักตัวอักษรจริง ถ้ามีไฟล์ .ttf ตัวหนาจริงของ DilleniaUPC ส่งมาเพิ่ม
// จะเปลี่ยนมาฝังไฟล์นั้นแทนเทคนิคนี้ให้
...
const DILLENIA_HAS_REAL_BOLD = false;
...
function loadThaiFontBold(){
  if(!THAI_FONT_BOLD_PROMISE) THAI_FONT_BOLD_PROMISE = loadThaiFontRegular();
...
// URL ยาวๆ) — จำเป็นต้องตัดกลางคำจริงๆ ตัดตามความกว้างจริงที่วัดจากฟอนต์
...
function appendRevLogPagesToPdf(pdfDoc, d, regularFont, boldFont, rgb){
  ...
  // ขนาด 16 ตามที่ระบุ — หัวตารางตัวหนา รายการในตารางตัวปกติ (regularFont/boldFont
  // ที่รับเข้ามาคือฟอนต์ไทยที่ฝังอยู่แล้ว — ดูหมายเหตุเรื่อง DilleniaUPC ท้ายไฟล์นี้)
  const bodySize = 16, headSize = 16, titleSize = 14, lineH = 22, cellPad = 6;
